...
if (isset($_POST['presentation_data'])) {
    ...
    $styleParts = [
        ...
        '.slide-media { width: 100%; height: 100%; border-radius: 18px; overflow: hidden; background-color: ' . $styles['color_bg'] . '; background-size: contain; background-position: center; background-repeat: no-repeat; }',
